...
class ElectronicsImage extends StatefulWidget {
  const ElectronicsImage({super.key});

  @override
  State<ElectronicsImage> createState() => _ElectronicsImageState();
}

class _ElectronicsImageState extends State<ElectronicsImage> {
