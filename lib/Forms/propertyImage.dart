...
class PropertImage extends StatefulWidget {
  const PropertImage({super.key});

  @override
  State<PropertImage> createState() => _PropertImageState();
}

class _PropertImageState extends State<PropertImage> {
